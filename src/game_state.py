...
class GameState:
    def __init__(self, file_path): # file_path sẽ là config.DATA_FILE_PATH
        ...
        self.current_music = "bg.mp3"  # nhạc mặc định
        ...
        self.last_day = None
        self.collected_gems = []
        self.lessons_hash = None  # Dùng để lưu hash của lesson.json
    ...
    def read_data(self):
        if os.path.exists(self.file_path):
            try:
                ...
                # THÊM PHẦN ĐỌC THÔNG TIN ÂM NHẠC
    ...
    def _set_default_data(self):
        ...
        # THÊM GIÁ TRỊ MẶC ĐỊNH CHO ÂM NHẠC
    ...
    def write_data(self):
        try:
            ...
            data_to_save = {
                ...
                # THÊM PHẦN LƯU THÔNG TIN ÂM NHẠC
